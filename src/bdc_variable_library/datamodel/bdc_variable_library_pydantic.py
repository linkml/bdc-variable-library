...
class ClinicalMeasurementRecord(ConfiguredBaseModel):
    ...
    unit: Optional[str] = Field(default=None, description="""A unit from UCUM""", json_schema_extra = { "linkml_meta": {'domain_of': ['ClinicalMeasurementRecord', 'SingleVariable'],
         'slot_uri': 'bdchm:unit'} })
...
class HumanBodyHeightRecord001(HumanBodyHeightRecord):
    """
    Measurement of linear distance of a standing human body from the bottom of a flat foot to the top-most point of the head measured with a wall-mounted stadiometer
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/linkml/clinical-microschemas',
...
class BodyMassIndexRecord(ClinicalMeasurementRecord):
    """
    A calculated numerical quantity representing an individual's weight-to-height ratio. BMI is calculated as weight (kg) divided by height (m) squared.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/linkml/clinical-microschemas',
         'rules': [{'postconditions': {'slot_conditions': {'calculated_from': {'equals_expression': '{HumanBodyWeightRecord001} '
                                                                                                    '/ '
...
class HumanBasophilCountRecord001(HumanBasophilCountRecord):
    ...
    unit: Optional[str] = Field(default=None, description="""A unit from UCUM""", json_schema_extra = { "linkml_meta": {'any_of': [{'equals_string': '10*3/uL'}],
         'domain_of': ['ClinicalMeasurementRecord', 'SingleVariable'],
         'slot_uri': 'bdchm:unit'} })
    method: Optional[MethodEnum] = Field(default=None, description="""The method used for the measurement""", json_schema_extra = { "linkml_meta": {'domain_of': ['ClinicalMeasurementRecord'], 'slot_uri': 'bdchm:method_type'} })
    instrument: Optional[InstrumentEnum] = Field(default=None, description="""The instrument used for the measurement""", json_schema_extra = { "linkml_meta": {'domain_of': ['ClinicalMeasurementRecord', 'ConditionStatusRecord']} })
    reagent_kit: Optional[ReagentKitEnum] = Field(default=None, description="""The reagent kit used for the measurement""", json_schema_extra = { "linkml_meta": {'domain_of': ['ClinicalMeasurementRecord']} })
...
class HumanBodyHeightQuantity001(HumanBodyHeightQuantity):
    """
    Standing wall-mounted-stadiometer human body height in cm, bounded 30–220.  Minimum represents observed limits on human height. Maximum represents limit of measurement device.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/linkml/clinical-microschemas',
...
class HumanBodyHeightQuantity002(HumanBodyHeightQuantity):
    """
    Standing wall-mounted-stadiometer human body height in in, bounded 20–90.  Minimum represents observed limits on human height. Maximum represents limit of measurement device.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/linkml/clinical-microschemas',
...
class CompoundVariable(Variable):
    ...
    bdchm_type: Optional[BdchmTypeEnum] = Field(default=None, description="""Entity type from BDCHM that defines the variable type""", json_schema_extra = { "linkml_meta": {'domain_of': ['CompoundVariable']} })
...
class MetadataVariable(Entity):
    ...
    variable_path: Optional[str] = Field(default=None, description="""Unique identifier pointing to variable""", json_schema_extra = { "linkml_meta": {'domain_of': ['MetadataVariable']} })
