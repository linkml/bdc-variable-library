# Contributing to bdc-variable-library

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
bdc-variable-library. These guidelines are not strict rules.
...
The bdc-variable-library team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the bdc-variable-library technical leads
...
[issues]: https://github.com/linkml/bdc-variable-library/issues/
[pulls]: https://github.com/linkml/bdc-variable-library/pulls/
